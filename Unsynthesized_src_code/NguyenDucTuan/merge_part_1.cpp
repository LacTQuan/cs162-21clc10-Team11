			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_sem == NULL){
                        ...
                        system("cls");
					    string COURSE_name_list_of_boxs[] = { "Create course","View course","Update course","Delete course","View student","Create mark","View scoreboard","Export course","Update result","Home","Return" };
					    COURSE_PAGE(year,import_sem,locate_x, locate_y, 11, COURSE_name_list_of_boxs);
                    }
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_class == NULL){
                        ...
                        system("cls");
                        string STUDENT_name_list_of_boxs[] = { "Create student","View students","Home","Return" }; 

					    STUDENT_PAGE(import_class,locate_x, locate_y, 4, STUDENT_name_list_of_boxs);
		...
		if (_kbhit()) {
			...
			if (var == 72) { //len
				...
				if (cell == 1){
                    ...
                    system("cls");
                    View_Enrolled_Course_main(year,sem,username);
                }else if(cell == 3){
                    system("cls");
                    Print_Course(sem);
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_sem == NULL){
                        ...
                        system("cls");
					    string COURSE_STU_name_list_of_boxs[] = { "Enroll course","View my course","Remove course" };
					    COURSE_STU_PAGE(username,year,import_sem,locate_x, locate_y, 3, COURSE_STU_name_list_of_boxs);
                    }
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_year == NULL){
					    ...
					    SEMESTER_STU_PAGE(username,import_year,60, 10, 4, SEMESTER_name_list_of_boxs);
                    }	
					system("cls");
					//
					if (HOME == 4) return;
...
void HOME_STUDENT_PAGE(string username,Year* &year, int locate_x,int locate_y, int number_of_cells, string HOME_name_list_of_boxs[]) {
