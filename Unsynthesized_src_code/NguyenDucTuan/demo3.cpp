...
// student
void COURSE_STU_PAGE(Year* &year,Semester* &sem, User U, int locate_x, int locate_y, int number_of_cells, string COURSE_name_list_of_boxs[],Registration_Session &S) { // lien: User
...
void CHANGE_PASS_PAGE(Year* &year, Account* account_head, User &U, int locate_x,int locate_y, int number_of_cells, string CHANGE_PASS_name_list_of_boxs[],Registration_Session &S){ // lien
...
void LOGIN_PAGE(Year* &year, Account* account_head, User U, int locate_x,int locate_y, int number_of_cells, string LOGIN_name_list_of_boxs[],Registration_Session &S) { // lien: account, user
...
int main() {
	...
	LOGIN_PAGE(year, account_head, U, 60, 10, 2, LOGIN_name_list_of_boxs,S); // lien: account, user
