...
void View_Enrolled_Course_main(Year*& year, Semester*& semester, string studentID) {
    // string studentID;
...
void Interface_Student(Year* &year, string StudentID) {
/*
    if (year == nullptr) { // need to find year
        ...
        if (choose_1 == 1) {
            ...
            do {
                ...
                if (choose_2 == 1) {
                    ...
                    // cin.ignore();
                    // getchar();
                    Delete_Enrolled_Course_main(year,sem);
                }
    ...
    do{
        ...
        if(choose_1 == 1){
            ...
            do{
                ...
                Print_Year(year);
                cout<<"--------------------------"<<endl;
                cout<<"1.Choose year to view semesters"<<endl;
                cout<<"2.Home"<<endl;
                cout<<"3.Return"<<endl;              
                ...
                if (choose_2 == 1) {
                    ...
                    do{
                        ...
                        cout<<"------------------------------"<<endl;                  
                        cout<<"1.Choose semester to view courses"<<endl;
                        cout<<"2.Home"<<endl;
                        cout<<"3.Return"<<endl; 
                        ...
                        if(choose_3 == 2) {
                            ...
                            do{
                                ...
                                if (choose_4 == 1){
                                    ...
                                    system("cls");
                                    View_Enrolled_Course_main(import_year, import_sem,StudentID);
                                    cin.ignore(1000, '\n');
                                    getchar();
                                    ...
                                    system("cls");
                                    Print_Course(import_sem);
                                    Delete_Enrolled_Course_main(import_year,import_sem,StudentID);
                                }                               
                                else if(choose_4 == 4) goto HOME;
                            } while (choose_4 != 5);
                        }else if (choose_3 == 2) goto HOME;
                    }while(choose_3 != 3);
                }
                if(choose_2 == 2) goto HOME;
            }while(choose_2 != 3);
        }
    }while(choose_1 != 2);
}
                    ...
                    do{
                        ...
                        if(choose_3 == 2) {
                            ...
                            do{
                                ...
                                cout<<"10.Export course main"<<endl;
                                cout<<"11.Update student result"<<endl;
                                cout<<"->Enter choose "; cin>>choose_4;
                                if(choose_4== 1){
                                    system("cls");
                                    Print_Course(import_sem);
...
void STUDENT_COUR_PAGE(Year* &year,Semester* &sem,int locate_x, int locate_y, int number_of_cells, string STUDENT_COUR_name_list_of_boxs[]) {
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_sem == NULL){
                        ...
                        system("cls");
					    string STUDENT_COUR_name_list_of_boxs[] = { "Create student","Update course","Delete course","View student","Create mark","View scoreboard","Export course","Update result","Home","Return" };
					    STUDENT_COUR_PAGE(year,import_sem,locate_x, locate_y, 10, STUDENT_COUR_name_list_of_boxs);
                    }
...
void STUDENT_PAGE(Class* &classes,int locate_x, int locate_y, int number_of_cells, string STUDENT_name_list_of_boxs[]) {
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_class == NULL){
                        ...
                        system("cls");
                        string STUDENT_name_list_of_boxs[] = { "Create student","Home","Return" }; 

					    STUDENT_PAGE(import_class,locate_x, locate_y, 3, STUDENT_name_list_of_boxs);
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if(import_year == NULL){
					    ...
					    CLASS_PAGE(import_year,locate_x, locate_y, 4, CLASS_name_list_of_boxs);
                    }		
					system("cls");
					//
					if (HOME == 4) return;
                    ...
                    if(import_year == NULL){
					    ...
					    SEMESTER_PAGE(import_year,60, 10, 4, SEMESTER_name_list_of_boxs);
                    }	
					system("cls");
					//
					if (HOME == 4) return;
...
void HOME_STAFF_PAGE(Year* &year, int locate_x,int locate_y, int number_of_cells, string HOME_name_list_of_boxs[]) {
...
// niem phong
void HOME_STUDENT_PAGE(Year* &year, int locate_x,int locate_y, int number_of_cells, string HOME_name_list_of_boxs[]) {
		...
		if (_kbhit()) {
			...
			if (var == 72) { //len
                ...
                if(cell == 1){
                    ...
                    if (username.back() == 'n'){
                        system("cls"); // staff
                        string HOME_STAFF_name_list_of_boxs[] = { "HOME","LOG OUT"};
                        HOME_STAFF_PAGE(year, locate_x, locate_y, 2, HOME_STAFF_name_list_of_boxs);
                        system("cls");
			...
			if (var == 72) { //len
				...
				if (cell == 1) {
                    ...
                    if (account_check(account_head, username, password)){
                        ...
                        getchar();
                        system("cls");
                        string CHANGE_PASS_name_list_of_boxs[] = { "CHANGE PASSWORD","HOME","LOG OUT"};
